...
#include <hakuroukun_hardware_gazebo/hakuroukun_hardware_gazebo.h>

namespace hakuroukun_hardware_gazebo
{
    using namespace hardware_interface;

    HakuroukunHardwareGazebo::HakuroukunHardwareGazebo()
        : gazebo_ros_control::RobotHWSim()
        , ns_("hakuroukun_hardware_gazebo/")
        , log_cnt_(0)
    {}


    bool HakuroukunHardwareGazebo::initSim(const std::string& robot_namespace,
        ros::NodeHandle nh,
  ...
  void HakuroukunHardwareGazebo::readSim(ros::Time time, ros::Duration period)
  {
  ...
  void HakuroukunHardwareGazebo::writeSim(ros::Time time, ros::Duration period)
  {
  ...
  void HakuroukunHardwareGazebo::CleanUp()
  {
    // wheel
    //-- wheel joint names
  ...
  void HakuroukunHardwareGazebo::GetJointNames(ros::NodeHandle &_nh)
  {
    this->GetWheelJointNames(_nh);
    this->GetSteerJointNames(_nh);
  }

  void HakuroukunHardwareGazebo::GetWheelJointNames(ros::NodeHandle &_nh)
  {
  ...
  void HakuroukunHardwareGazebo::GetSteerJointNames(ros::NodeHandle &_nh)
  {
    // steer joint to get angular command
    _nh.getParam(ns_ + "front_steer", front_steer_jnt_name_);
  }

  void HakuroukunHardwareGazebo::RegisterHardwareInterfaces()
  {
  ...
  void HakuroukunHardwareGazebo::RegisterInterfaceHandles(
  ...
  void HakuroukunHardwareGazebo::RegisterWheelInterface()
  {
    // actual wheel joints
  ...
  void HakuroukunHardwareGazebo::RegisterSteerInterface()
  {
    // actual steer joints
    this->RegisterInterfaceHandles(
  ...
  void HakuroukunHardwareGazebo::RegisterJointStateInterfaceHandle(
      hardware_interface::JointStateInterface& _jnt_state_interface,
      const std::string _jnt_name, double& _jnt_pos, double& _jnt_vel, double& _jnt_eff)
  {
  ...
  void HakuroukunHardwareGazebo::RegisterCommandJointInterfaceHandle(
      hardware_interface::JointStateInterface& _jnt_state_interface,
      hardware_interface::JointCommandInterface& _jnt_cmd_interface,
  ...
  double HakuroukunHardwareGazebo::ComputeEffCommandFromVelError(
    const int _index, const int _front_rear, ros::Duration _period)
  {
    double vel_error = 0;
    if(_front_rear == FRONT)
        vel_error = rear_wheel_jnt_vel_cmd_ ;
  ...
  void HakuroukunHardwareGazebo::GetCurrentState(std::vector<double>& _jnt_pos, std::vector<double>& _jnt_vel, std::vector<double>& _jnt_eff,
...
PLUGINLIB_EXPORT_CLASS(hakuroukun_hardware_gazebo::HakuroukunHardwareGazebo, gazebo_ros_control::RobotHWSim)
