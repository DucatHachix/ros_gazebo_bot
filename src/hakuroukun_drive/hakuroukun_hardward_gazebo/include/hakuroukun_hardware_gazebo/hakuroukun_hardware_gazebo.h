...
#ifndef HAKUROUKUN_HARDWARE_GAZEBO_H
#define HAKUROUKUN_HARDWARE_GAZEBO_H
...
namespace hakuroukun_hardware_gazebo
{
    ...
    class HakuroukunHardwareGazebo : public gazebo_ros_control::RobotHWSim
    {
        public:

            HakuroukunHardwareGazebo();
        ...
        private:
            ...
            void GetJointNames(ros::NodeHandle &_NodeHandlenh);
...
#endif // HAKUROUKUN_HARDWARE_GAZEBO_H
